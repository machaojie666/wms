...
<s:form id="searchForm" action="role.action">
    <div id="container">
        <div class="ui_content">
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_bottom">
                        <input type="button" value="新增" data-url="<s:url namespace="/" action="role_input"/>"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:;" data-url="<s:property value="deleteURL"/>"
                                   data-id="<s:property value="id"/>" class="btn_delete">删除</a>
                            </td>
                        </tr>
                    </s:iterator>
                    </tbody>
