...
<s:form name="editForm" namespace="/" action="orderBill_saveOrUpdate" id="editForm">
    <div id="container">
        <div id="nav_links">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:select list="#suppliers" listValue="name" listKey="id" name="orderBill.supplier.id"
