...
<s:form name="editForm" namespace="/" action="stockOutcomeBill" id="editForm">
    <div id="container">
        <div id="nav_links">
            <span style="color: #1A5CC6;">入库单查看</span>
            <div id="page_close">
                <a>
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        &nbsp;
                        <input type="button" value="回到列表" class="ui_input_btn01 btn_submit" onclick="window.history.back()"/>
                    </td>
                </tr>
            </table>
        </div>
