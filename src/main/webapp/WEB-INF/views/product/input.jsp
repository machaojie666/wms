...
<s:form name="editForm" namespace="/" action="product_saveOrUpdate" id="editForm" enctype="multipart/form-data">
    <div id="container">
        <div id="nav_links">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:select list="#brands" listKey="id" name="product.brand.id" listValue="name" cssClass="ui_select01"></s:select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        ...
                        <s:property value="product.imagePath"/>
                        <img src="<s:property value="product.imagePath"/> " class="list_img">
                    </td>
                </tr>
                <tr>
