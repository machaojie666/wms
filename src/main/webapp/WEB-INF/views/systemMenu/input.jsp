...
<s:form name="editForm" namespace="/" action="systemMenu_saveOrUpdate" id="editForm">
    <div id="container">
        <div id="nav_links">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:textfield name="systemMenu.parent.name" cssClass="ui_input_txt02" value="%{#parentName}"
                                     readonly="true" style="background-color:red"></s:textfield>
                    </td>
                </tr>
